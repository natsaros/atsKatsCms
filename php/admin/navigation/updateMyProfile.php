...
<form name="updateUserForm" role="form" action="<?php echo getAdminActionRequestUri() . "user" . DS . "update"; ?>"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="First Name"
                                   ...
                                   id="firstname_input"
                                   value="<?php echo $currentUser->getFirstName() ?>" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Last Name"
                                   ...
                                   value="<?php echo $currentUser->getLastName() ?>" required>
                        </div>
                        <div class="form-group">
