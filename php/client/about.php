...
<div class="container-fluid gallery-container">
    <div class="row row-no-padding">
        <div class="col-sm-12 text-center">
            ...
            <div id="images">
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/ALM_8477.jpg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/ALM_8520.jpg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/magazine.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/salon.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/towels.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/welcomeDoor.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/pen_cad1.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/pen_cad2.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/pen_cad3.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/pen_cad4.jpeg">
                </div>
                <div class="item">
                    <img src="<?php echo ASSETS_URI ?>img/recent/pen_ref.jpeg">
                </div>
            </div>
        </div>
    </div>
