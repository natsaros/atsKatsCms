<head>
    ...
    <meta property="og:title" itemprop="name" content="Σelliνόφως" >
    <meta property="og:image" content="http://sellinofos.gr/assets/img/sellinofos/sellinofos_logo.png">
    <!--    --><?php //} ?>
    <meta property="og:site_name" content="sellinofos.gr" >
    <meta property="og:description" content="Γιατί η δημιουργία είναι ο καλύτερος τρόπος να απολαμβάνεις τη ζωή!" >
