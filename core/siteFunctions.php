...
function defineSystemVariables() {
    ...
    defined('COMMON_STR') or define('COMMON_STR', 'core');
    ...
    defined('ADMIN_ROOT_PATH') or define('ADMIN_ROOT_PATH', ADMIN_STR . PHP_ROOT_PATH . DS);
    defined('ADMIN_NAV_PATH') or define('ADMIN_NAV_PATH', ADMIN_STR . PHP_ROOT_PATH . DS . NAV_STR . DS);
    defined('ADMIN_MODAL_NAV_PATH') or define('ADMIN_MODAL_NAV_PATH', ADMIN_STR . PHP_ROOT_PATH . DS . NAV_STR . DS . MODAL_STR . DS);
    defined('ADMIN_ACTION_PATH') or define('ADMIN_ACTION_PATH', ADMIN_STR . PHP_ROOT_PATH . DS . ACTION_STR . DS);

    defined('CLIENT_ROOT_PATH') or define('CLIENT_ROOT_PATH', CLIENT_STR . PHP_ROOT_PATH . DS);
    defined('CLIENT_ACTION_PATH') or define('CLIENT_ACTION_PATH', CLIENT_ROOT_PATH . ACTION_STR . DS);
    defined('CLIENT_AJAX_ACTION_PATH') or define('CLIENT_AJAX_ACTION_PATH', CLIENT_STR . PHP_ROOT_PATH . DS . AJAX_ACTION_STR . DS);
    defined('ADMIN_AJAX_ACTION_PATH') or define('ADMIN_AJAX_ACTION_PATH', ADMIN_STR . PHP_ROOT_PATH . DS . AJAX_ACTION_STR . DS);

    defined('COMMON_ROOT_PATH') or define('COMMON_ROOT_PATH', COMMON_STR . PHP_ROOT_PATH . DS);
